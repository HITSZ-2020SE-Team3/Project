...
public class OtherLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acticity_other);
            ...
            public void onClick(View view) {
                ...
                mFingerprintIdentify.startIdentify(3, new BaseFingerprint.FingerprintIdentifyListener() {
                    ...
                    public void onNotMatch(int availableTimes) {
                        ...
                        Toast.makeText(OtherLoginActivity.this, "onNotMatch", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onFailed() {
                        ...
                        Toast.makeText(OtherLoginActivity.this, "onFailed", Toast.LENGTH_SHORT).show();
                        mFingerprintIdentify.cancelIdentify();
                    }
                });
            }
...
//        });
        ...
        mVerifyGestureUnlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GestureUnlock.getInstance().init(OtherLoginActivity.this.getApplicationContext());
                GestureUnlock.getInstance().verifyGestureUnlock(OtherLoginActivity.this);
            }
        });
        // 修改手势密码
        mModifyGestureUnlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GestureUnlock.getInstance().init(OtherLoginActivity.this.getApplicationContext());
                GestureUnlock.getInstance().modifyGestureUnlock(OtherLoginActivity.this);
            }
        });
    }
