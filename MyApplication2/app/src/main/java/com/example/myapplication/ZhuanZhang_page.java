...
public class ZhuanZhang_page extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //页面显示
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zhuan_zhang_page);
        ...
        //活动跳转到转账界面
        TextView Text2 = (TextView) findViewById(R.id.shouru_page);
        Text2.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ZhuanZhang_page.this, shouru_page.class);
                startActivity(intent);
            }
        }));
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.navigation_detail://统计
                        Intent intent1 = new Intent(ZhuanZhang_page.this, statisticActivity.class);
                        startActivity(intent1);
                        break;
                    case R.id.navigation_liushui://流水
                        Intent intent2 = new Intent(ZhuanZhang_page.this, turnoverActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.navigation_add://记账
                        Intent intent3 = new Intent(ZhuanZhang_page.this, ZhuanZhang_page.class);
                        startActivity(intent3);
                        break;
                    case R.id.navigation_chart://图表
                        Intent intent4 = new Intent(ZhuanZhang_page.this, ChartActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.navigation_person://我的
                        Intent intent5 = new Intent(ZhuanZhang_page.this, MyActivity.class);
